...
maxlat:-Infinity,minlat:Infinity},Ka={},D=!1,Za=null,Y="HTMLCanvasElement"in window,N="devicePixelRatio"in window?window.devicePixelRatio:1,Fa,Oa=null;(function(){var a=e.wma||window.location.search.substr(1);var b=e.page,c=e.lang;wa=e.globe||"Earth";b&&Y&&$.ajax({url:"//tools.wmflabs.org/wiwosm/osmjson/getGeoJSON.php?lang="+c+"&article="+b,dataType:"json",success:ob});Za=function(){if(!Y)return function(){};var d="mapFull"==O?256:128,k=$("<canvas></canvas>").attr({width:24*d/3,height:12*d/3}).css({display:"none"}),
